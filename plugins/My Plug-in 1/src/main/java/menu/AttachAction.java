...
//    Profile profile = StereotypesHelper.getProfile(project, Environment.DIGITAL_THREAD_PROFILE);
//    if (profile == null) {
...
//      Stereotype stereotype = StereotypesHelper.createStereotype(profile, Environment.DIGITAL_THREAD_STEREOTYPE, Arrays.asList(metaClass));
